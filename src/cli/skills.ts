...
export interface RecommendedSkill {
  /** Local permission/config name for this skill */
  name: string;
  /** Git repository used by external skill installers */
  repo: string;
  /** Skill folder/name within the repository */
  skillName: string;
  /** List of agents that should auto-allow this skill */
  allowedAgents: string[];
  /** Human-readable description */
  description: string;
  /** Optional commands users may need to run after installing the skill */
...
export function getSkillPermissionsForAgent(
  ...
  // Apply permissions from recommended external skills.
